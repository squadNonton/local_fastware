...
<main id="main" class="main">
    ...
    const inputFields = ["thickness", "weight", "inner_diameter", "outer_diameter", "length", "qty", "m1", "m2", "m3"];
...
function initializeSearchableDropdown(searchInput, dropdownMenu, hiddenInput, nameCustomerInput, selectedCustomersList) {
    searchInput.addEventListener("input", function() {
